    ...
    def parse_payload(self):
        ...
        def _PARSE(packet_name, packet_text, entry):
            ...
            if packet_name == '0xB0E5':
                ...
                print('0xB883')
                return Packet_0xB883(packet_text, config2['0xB883'], entry).extract_info()
            elif packet_name == '0xB884':
                print('0xB884')
                return Packet_0xB884(packet_text, config2['0xB884'], entry).extract_info()
            elif packet_name == '0xB889':
                print('0xB889')
                return Packet_0xB889(packet_text, config2['0xB889'], entry).extract_info()
...
Report
   ...
   """)
        ...
        msg = ParsedRawMessage(index=0, packet_type="0xB0E3", packet_length=100,
                               ...
                               subtitle="PDN connectivity request Msg", datetime="2024 Jan 15  07:17:10.651", packet_text=
                               """
