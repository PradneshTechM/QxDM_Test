...
def callingFunctionality():
    ...
    cmd = "curl -X POST https://7bfc56fb456d447e9337209c889d211e@api-dev.headspin.io/v0/adb/96031FFBA001J1/shell -d \"am start -a android.intent.action.CALL -d tel:4696137552\""
    ...
    for i in range(10):
        ...
        for j in range(5):
            if output.__contains__("mCallState=1"):
                ...
                subprocess.call(
                "curl -X POST https://7bfc56fb456d447e9337209c889d211e@api-dev.headspin.io/v0/adb/96071FFBA00048/shell -d \"input keyevent 5\"", shell=True)
                call_flag=1
                break
            else:
                time.sleep(1)
    ...
    # time.sleep(60)
    subprocess.call(
        "curl -X POST https://7bfc56fb456d447e9337209c889d211e@api-dev.headspin.io/v0/adb/96031FFBA001J1/shell -d \"input keyevent 6\"",
        shell=True)
